            ...
            {contactInfo.map((info, index) => (
              ...
              >
                {info.link ? (
                  <a
                    href={info.link}
                    className="block p-4 rounded-xl border border-border bg-card hover:border-primary/50 transition-colors duration-300 text-center"
                  >
                  ...
                  <div className="block p-4 rounded-xl border border-border bg-card text-center">
                    <info.icon className="w-6 h-6 text-primary mx-auto mb-2" />
                    <h3 className="font-medium text-foreground text-sm mb-1">{info.title}</h3>
                    <p className="text-muted-foreground text-xs">{info.value}</p>
                  </div>
                  ...
                  <form onSubmit={budgetForm.handleSubmit(onBudgetSubmit)} className="p-6 md:p-8 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        {budgetForm.formState.errors.name && (
                          <p className="text-sm text-destructive">{budgetForm.formState.errors.name.message}</p>
                        )}
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          type="email"
                          placeholder="seu@email.com"
                          {...budgetForm.register("email")}
                          className="bg-muted border-border"
                        />
                        {budgetForm.formState.errors.email && (
                          <p className="text-sm text-destructive">{budgetForm.formState.errors.email.message}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <select
                          id="budget-type"
                          {...budgetForm.register("projectType")}
                          className="w-full h-10 px-3 rounded-md bg-muted border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                        >
                        ...
                        {budgetForm.formState.errors.projectType && (
                          <p className="text-sm text-destructive">{budgetForm.formState.errors.projectType.message}</p>
                        )}
                      </div>
                      <div className="space-y-2">
                        ...
                        {budgetForm.formState.errors.budget && (
                          <p className="text-sm text-destructive">{budgetForm.formState.errors.budget.message}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="budget-deadline"
                        placeholder="Ex: 3 meses, Janeiro/2025..."
                        {...budgetForm.register("deadline")}
                        className="bg-muted border-border"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="bg-muted border-border resize-none"
                      />
                      {budgetForm.formState.errors.description && (
                        <p className="text-sm text-destructive">{budgetForm.formState.errors.description.message}</p>
                      )}
                    </div>
