...
const stats = [
  ...
  { icon: Clock, value: "5+", label: "Anos de Mercado" },
  { icon: Rocket, value: "99%", label: "Satisfação" },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Sobre a <span className="text-gradient">NexusDev</span>
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <SectionTitle
            ...
            subtitle="Uma jornada de inovação e crescimento contínuo"
          />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <SectionTitle
            ...
            subtitle="Os princípios que guiam nossa atuação"
          />
