...
export const WhatsAppButton = ({ phoneNumber, message }: WhatsAppButtonProps) => {
  ...
  const defaultMessage = `Olá! Gostaria de saber mais sobre os serviços da ${siteName}.`;
  const whatsappUrl = buildWhatsAppUrl(targetPhone, message ?? defaultMessage);
  ...
  return (
    <a
      ...
      onClick={() => pushConversion("whatsapp_click", { source: "floating_button" })}
      ...
      aria-label={`Contato via WhatsApp — ${siteName}`}
    >
